                                ...
                                <tr>
                                    <td style="padding: 40px 30px;">
                                        ...
                                        <table width="100%%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                            <tr>
                                                <td align="center">
                                                    <a href="https://hutech-auction.click/auctions" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #ff6b35 0%%, #f7931e 100%%); color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 12px rgba(255, 107, 53, 0.4);">
                                                        🔥 Khám phá ngay
                                                    </a>
                                                </td>
                                            </tr>
